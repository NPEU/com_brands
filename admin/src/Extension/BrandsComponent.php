...
namespace NPEU\Component\Brands\Administrator\Extension;
...
class BrandsComponent extends MVCComponent implements
    RouterServiceInterface, BootableExtensionInterface
{
    ...
    {
        $this->getRegistry()->register('brandsadministrator', new AdministratorService);
    }
