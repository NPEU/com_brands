...
namespace NPEU\Component\Brands\Administrator\Table;
 ...
 * @since  1.0
 */
#class BrandTable extends Nested implements VersionableTableInterface, TaggableTableInterface
class BrandTable extends Table
{
    ...
    public function __construct(DatabaseDriver $db) {
        $this->typeAlias = 'com_brands.brand';
